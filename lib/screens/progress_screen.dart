          ...
          Card(
            ...
            child: Column(children: [
              const ListTile(
                ...
                subtitle: Text('Tahniah untuk setiap langkah kecil!'),
              ),
              const Divider(height: 1),
              _milestoneTile('24 jam', days >= 1,  'Oksigen darah pulih ke paras normal.'),
              _milestoneTile('3 hari', days >= 3,  'Tahap nikotin turun, deria rasa & bau bertambah baik.'),
              _milestoneTile('1 minggu', days >= 7,'Paras tenaga meningkat, tidur lebih berkualiti.'),
              _milestoneTile('1 bulan', days >= 30,'Fungsi paru-paru bertambah baik; batuk berkurang.'),
              const SizedBox(height: 8),
            ]),
          ),
